...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 24 oct. 2025 à 09:17
...
(11, 'Zallila', 'Adam', 'M', 'Compétitif', 'Actif', NULL, NULL, NULL, 'S2025', 'Entraineur'),
(12, 'Jaber', 'Ons', 'F', 'Entraineur', 'Actif', '1234', 'rue x', '123456789', 'S2025', 'Compétitif'),
...
(546, '2025-10-23', '18:00:00', '19:30:00', 'Poussin-1-B', 'Zallila Adam', 2, NULL, 'entrainement', 90, 'S2025'),
...
--
ALTER TABLE `seances`
  MODIFY `seance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=548;
